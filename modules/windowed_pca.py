...
#    @njit()                                                                        ### BRING BACK
    ...
    def gt_process_win(self):
        ...
        if self.win:
            ...
            if self.min_maf: self.gt_min_maf_filter()
            ...
            for line in variant_file:
                ...
                while self.w_stop < pos:
                    ...
                    if self.win: self.gt_process_win(
                        self.win, self.w_start, self.w_size, 
                        self.min_maf, self.func
                    )
                    if self.stop < self.w_stop: break
                    self.w_start, self.w_stop, self.w_idx, self.win = \
                        self.init_win(
                            self.w_start, self.w_stop,
                            self.w_idx, self.win,
